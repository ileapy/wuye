<template>
	<view class="u-subsection" ref="u-subsection" :class="[`u-subsection--${mode}`]"
	...
	export default {
		...
		computed: {
			...
			barStyle() {
				...
				style.backgroundImage = `linear-gradient(to right,${this.itemBg[0]},${this.itemBg[1]})`
				// style.backgroundColor=this.itemBg[0]
				// style.backgroundColor=this.itemBg[0]
